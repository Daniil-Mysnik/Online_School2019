package net.thumbtack.school.thread.Task18;

import net.thumbtack.school.thread.Task17.Event;
...
public class Task18 {
    public static void main(String[] args) throws InterruptedException {
        ...
        Thread[] developers = new Thread[5];
        Thread[] executors = new Thread[7];
...
class Developer implements Runnable {
    ...
    public void run() {
        if (new Random().nextInt(2) == 1) {
            ...
            new Thread(new Developer(queue, eventQueue)).start();
            System.out.println("Developer launched a new developer");
        }
    }
